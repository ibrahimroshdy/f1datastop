# Generated by Django 3.2.15 on 2023-02-22 21:39
    ...
    operations = [
        ...
        migrations.CreateModel(
                ...
                fields=[
                    (
                        'constructorid',
                        models.BigAutoField(db_column='constructorId', primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
                ...
                fields=[
                    ('driverid',
                     models.CharField(db_column='driverId', max_length=255, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
                ...
                fields=[
                    ...
                    ('circuitid', models.ForeignKey(db_column='circuitId', on_delete=django.db.models.deletion.CASCADE,
                                                    to='formula1.circuits')),
                ],
                options={
                    'verbose_name': 'Race',
        ...
        migrations.CreateModel(
                ...
                fields=[
                    ('sprintresultid',
                     models.BigAutoField(db_column='sprintResultId', primary_key=True, serialize=False)),
                    ...
                    ('fastestlaptime',
                     models.CharField(blank=True, db_column='fastestLapTime', max_length=255, null=True)),
                    ('constructorid',
                     models.ForeignKey(db_column='constructorId', on_delete=django.db.models.deletion.CASCADE,
                                       to='formula1.constructors')),
                    ('driverid', models.ForeignKey(db_column='driverId', on_delete=django.db.models.deletion.CASCADE,
                                                   to='formula1.drivers')),
                    ('raceid', models.ForeignKey(db_column='raceId', on_delete=django.db.models.deletion.CASCADE,
                                                 to='formula1.races')),
                    ('statusid', models.ForeignKey(db_column='statusId', on_delete=django.db.models.deletion.CASCADE,
                                                   to='formula1.status')),
                ],
                options={
        ...
        migrations.CreateModel(
                ...
                fields=[
                    ...
                    ('fastestlaptime',
                     models.CharField(blank=True, db_column='fastestLapTime', max_length=255, null=True)),
                    ('fastestlapspeed',
                     models.CharField(blank=True, db_column='fastestLapSpeed', max_length=255, null=True)),
                    ('constructorid',
                     models.ForeignKey(db_column='constructorId', on_delete=django.db.models.deletion.CASCADE,
                                       to='formula1.constructors')),
                    ('driverid', models.ForeignKey(db_column='driverId', on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.AddField(
                model_name='races',
                name='year',
                field=models.ForeignKey(db_column='year', on_delete=django.db.models.deletion.CASCADE,
                                        to='formula1.seasons'),
        ),
        migrations.CreateModel(
                name='Qualifying',
        ...
        migrations.CreateModel(
                ...
                fields=[
                    ('driverstandingsid',
                     models.BigAutoField(db_column='driverStandingsId', primary_key=True, serialize=False)),
                    ('points', models.FloatField()),
                    ('position', models.IntegerField(blank=True, null=True)),
        ...
        migrations.CreateModel(
                ...
                fields=[
                    ('constructorstandingsid',
                     models.BigAutoField(db_column='constructorStandingsId', primary_key=True, serialize=False)),
                    ('points', models.FloatField()),
                    ('position', models.IntegerField(blank=True, null=True)),
                    ('positiontext', models.CharField(blank=True, db_column='positionText', max_length=255, null=True)),
                    ('wins', models.IntegerField()),
        ...
        migrations.CreateModel(
                ...
                fields=[
                    ('constructorresultsid',
                     models.BigAutoField(db_column='constructorResultsId', primary_key=True, serialize=False)),
